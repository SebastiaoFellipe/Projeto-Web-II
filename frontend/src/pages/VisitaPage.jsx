...
const fields = [
  ...
  { name: 'tipoInstituicao', label: 'Tipo de Instituição' },
  { name: 'professorResponsavel', label: 'Professor Responsável' },
...
const tableColumns = [
  ...
  { key: 'qtdAlunos', label: 'Alunos' },
];

const emptyForm = { nome: '', data: '', hora: '', instituicao: '', tipoInstituicao: '', professorResponsavel: '', qtdAlunos: 0, telefone: '' };
