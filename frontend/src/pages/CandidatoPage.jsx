...
const ENTITY = "Candidato";

const fields = [
  { name: "nome", label: "Nome" },
  { name: "cpf", label: "CPF" },
  { name: "formacaoAcademica", label: "Formação" },
  { name: "email", label: "Email", type: "email" },
];

const empty = { nome: "", cpf: "", formacaoAcademica: "", email: "" };
  ...
  return (
    <div>
      ...
      <div className="table-container">
        <table>
          <thead><tr><th>ID</th><th>Nome</th><th>Email</th><th>Formação</th><th style={{ textAlign: "right" }}>Ações</th></tr></thead>
          <tbody>
            {items.map((it) => (
              <tr key={it.id}>
                <td>{it.id}</td>
