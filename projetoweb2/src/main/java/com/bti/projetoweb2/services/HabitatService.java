...
public class HabitatService {
    ...
    public Page<Habitat> listarTodos(String descricao, Pageable pageable) {
        if (descricao != null && !descricao.isEmpty()) {
            return habitatRepository.findByDescricaoContainingIgnoreCase(descricao, pageable);
        }
        return habitatRepository.findAll(pageable);
    }
